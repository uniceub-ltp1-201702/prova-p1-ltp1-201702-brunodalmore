...
public class BDSimulado {
		...
		for (int i = 0; i < this.clientes.size(); i++) {
			if(this.clientes.get(i).getNome().equals(nome)) {
				resultado = "\n Nome: " + this.clientes.get(i).getNome() + "\n" +
			        ...
			        "Numero do Telefone: " + this.clientes.get(i).getNumeroTelefone() + "\n" +
    ...
    public int ligacoesPorCliente(String nome){
    		int resultado=0;
    ...
    public String getligacoesPorUF(String UF){
    	String resultado = "";
    	
    	for (int i = 0; i <this.ligacoes.size(); i++) {
			if(this.ligacoes.get(i).getCliente().getNome().equals(UF)){
				resultado = this.ligacoes.get(i).getUFDestino();
			}
		}
    	return resultado;
    }
